...
function Card({username,btntext}) {
  return (
    <>
    <div className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 text-center mx-auto">
        ...
        <div className="flex flex-col items-center pb-10">
            <img className="w-24 h-24 mb-3 rounded-full shadow-lg" src="https://img.freepik.com/premium-photo/beautiful-red-yellow-tulips-flowerbed-spring-park_392053-4683.jpg?w=360" alt="Bonnie image"/>
